...
<body>
					...
					<div class="container forms edit-modal">
						<form action="updateres.php" method="post">
							...
							<div class="form-group">
								...
								<input type="number" name="phno" id="phno" class="form-control" placeholder="Enter Phone number" min="1000000000" max="9999999999" required>
							</div>
	...
	<div class="modal fade" id="deletedetails" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
		<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
			<div class="modal-content">
				<div class="modal-header">
					<h5 class="modal-title" id="Editmodaltitle">Delete Resident</h5>
					<button type="button" class="close" data-dismiss="modal" aria-label="Close">
          			<span aria-hidden="true">&times;</span>
        			</button>
				</div>
				<div class="modal-body">
					<div class="container forms edit-modal">
						<form action="deleteres.php" method="post">
							...
							<button type="submit" class="btn btn-primary" style="width: 100%;">Delete Resident</button>
						</form>
					</div>
	...
	<div class="jumbotron-fluid" style="margin-top: 20px;">
		...
		<div class="container-fluid">
			<div class="row" style="margin-bottom: 20px;">
				...
				<div class="col-sm-2">
					<button class="btn btn-primary btn-block" data-toggle="modal" data-target="#deletedetails">
					Delete
					</button>
				</div>
			</div>
