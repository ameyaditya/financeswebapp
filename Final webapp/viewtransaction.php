...
<body>
	...
	<div id="filter-icon">
		<button class="btn" type="button" id="submit-filter" data-toggle="modal" data-target="#filtermodal"></button>
	</div>
	...
	<div class="container-fluid" id="main-table">
		<table class="table">
			...
			<tbody id="table-body">
					{% for id, date, itinerary, from, to, mode, amount, vno, description in data %}
					<tr>
						<td>{{ id }}</th>
						<td>{{ date }}</td>
						<td>{{ itinerary }}</td>
