...
<body style="background-color: #f5f5f5;">
	<nav class="navbar navbar-expand navbar-dark bg-dark">
		...
		<button class="btn btn-light navbar-right" onclick="window.location.href='logout.php' ">Logout</button>
	</nav>
	...
	<div class="container">
		...
		<div class="row" style="margin-top: 58px;">
			<div class="col-4 d-flex justify-content-center justify-align-center">
				<div class="bg-light button" id="selection" onclick="window.location.href='deleteaccount.php'" style="padding-top:10px;"> Delete Account
				</div>
			</div>
		</div>
	</div>
